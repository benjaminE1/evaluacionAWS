...
<div class="max-w-2xl mx-auto p-4 lg:p-6">
    <div class="glass rounded-lg shadow-lg overflow-hidden">
        ...
        <div class="bg-gradient-to-r from-military-800 to-military-700 px-6 py-6">
            <h1 class="text-3xl font-bold text-white">➕ Nuevo Fabricante</h1>
        </div>

        <!-- Form -->
        <form method="POST" action="{{ route('fabricantes.store') }}" class="p-6 space-y-6">
            @csrf
            ...
            <div>
                ...
                <input type="number" id="año_fundacion" name="año_fundacion" value="{{ old('año_fundacion') }}" min="1800" max="2100"
