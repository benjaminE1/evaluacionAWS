...
<div class="max-w-2xl mx-auto p-4 lg:p-6">
    <div class="glass rounded-lg shadow-lg overflow-hidden">
        ...
        <div class="bg-gradient-to-r from-military-800 to-military-700 px-6 py-6">
            <h1 class="text-3xl font-bold text-white">➕ Nueva Munición</h1>
        </div>

        <!-- Form -->
        <form method="POST" action="{{ route('municiones.store') }}" class="p-6 space-y-6">
            @csrf
            ...
            <div>
                ...
                <input type="text" id="calibre" name="calibre" value="{{ old('calibre') }}" placeholder="ej: 75mm" required
            ...
            <div>
                ...
                <input type="text" id="tipo" name="tipo" value="{{ old('tipo') }}" placeholder="ej: Perforante, Explosiva" required
